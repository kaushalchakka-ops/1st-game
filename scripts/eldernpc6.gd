...
func speak():
		label.text = "
		Hero, your long attack has been increased. Take this bow for better reach!Your character have been upgraded press 3:to archer and click to shoot"
		...
		if player_ref:
			player_ref.transform_to_archer()
